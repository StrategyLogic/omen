...
def test_actor_required_artifacts(tmp_path: Path, actor_case_file: Path, monkeypatch) -> None:
...
def test_strategic_actor_with_extra_fields(tmp_path: Path, monkeypatch, capsys) -> None:
  payload = {
    "meta": {
      "case_id": "xd",
      "version": "v0.1.0-actor",
